...
Hardened by [Chainguard](https://www.chainguard.dev) from the upstream action at [https://github.com/aws-actions/amazon-ecs-render-task-definition](https://github.com/aws-actions/amazon-ecs-render-task-definition).

## Versions

| Version | Tag | Upstream commit |
|---------|-----|-----------------|
| v1.8.3 | [`v1.8.3`](https://github.com/chainguard-actions/aws-actions-amazon-ecs-render-task-definition/tree/v1.8.3) | [`6b89923`](https://github.com/aws-actions/amazon-ecs-render-task-definition/commit/6b89923a897d41e9ad789181d8865b532ecf973c) |
